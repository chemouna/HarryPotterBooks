...
import com.mounacheikhna.harrypotterbooks.ui.book.BooksAdapter;
import com.mounacheikhna.harrypotterbooks.ui.view.CustomViewAnimator;
import com.mounacheikhna.harrypotterbooks.ui.view.recyclerview.HeaderFooterAdapter;
...
public class CartView extends FrameLayout implements CartScreen {
  ...
  @Override protected void onFinishInflate() {
    ...
    HarryPotterBooksApp.get(getContext()).getComponent().injectCartView(this);
