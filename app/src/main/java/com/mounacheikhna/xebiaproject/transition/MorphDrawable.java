...
@TargetApi(Build.VERSION_CODES.LOLLIPOP) public class MorphDrawable extends Drawable {
  ...
  public static final Property<MorphDrawable, Float> CORNER_RADIUS =
      new Animations.FloatProperty<MorphDrawable>("cornerRadius") {
        ...
        @Override public void setValue(MorphDrawable morphDrawable, float value) {
          morphDrawable.setCornerRadius(value);
        }

        @Override public Float get(MorphDrawable morphDrawable) {
          return morphDrawable.getCornerRadius();
        }
      };
  public static final Property<MorphDrawable, Integer> COLOR =
      new Animations.IntProperty<MorphDrawable>("color") {
